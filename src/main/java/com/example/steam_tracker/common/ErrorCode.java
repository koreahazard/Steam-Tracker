...
public enum ErrorCode {
	 ...
	 * 게임 예외처리
	 * ========================= */
	GAME_NOT_FOUND(HttpStatus.NOT_FOUND, "게임 정보가 존재하지 않습니다."),

	/* =========================
	 * 위시리스트 예외처리
	 * ========================= */
	WISH_LIST_NOT_FOUND(HttpStatus.NOT_FOUND, "위시리스트가 존재하지 않습니다."),
	WISH_LIST_UNAUTHORIZED(HttpStatus.FORBIDDEN, "본인의 위시리스트만 삭제할 수 있습니다.");
